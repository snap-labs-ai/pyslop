...
That copies the packaged detect-shims analyzer into `pyslop_extensions/detect_shims/` and appends it to `pyslop.toml`. It is an entry-point extension (not a command extension).
